namespace :pl do
  ...
  # set our default directory to be "pkg"
  $DEFAULT_DIR = "pkg"
  ...
  task :sign_swix, :root_dir do |_t, args|
    swix_dir = args.root_dir || $DEFAULT_DIR
  ...
  task :sign_svr4, :root_dir do |_t, args|
    svr4_dir = args.root_dir || $DEFAULT_DIR
  ...
  task :sign_rpms, :root_dir do |t, args|
    rpm_dir = args.root_dir || $DEFAULT_DIR
  ...
  task :sign_ips, :root_dir do |_t, args|
    ips_dir = args.root_dir || $DEFAULT_DIR
  ...
  task :sign_gem, :root_dir do |_t, args|
    gems_dir = args.root_dir || $DEFAULT_DIR
  ...
  task :sign_deb_changes, :root_dir do |_t, args|
    begin
      deb_dir = args.root_dir || $DEFAULT_DIR
  ...
  namespace :jenkins do
    ...
    task :sign_all, :root_dir do |_t, args|
      ...
      root_dir = args.root_dir || $DEFAULT_DIR
...
DOC
      ...
      Pkg::Util::Net.rsync_from("#{remote_repo}/#{root_dir}/", Pkg::Config.signing_server, "#{$DEFAULT_DIR}/")
      ...
      puts "Signed packages staged in #{$DEFAULT_DIR}/ directory"
    end
  end
end